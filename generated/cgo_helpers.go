...
func (x RkllmStreamCallback) PassRef() (ref *C.RkllmStreamCallback, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if rkllmStreamCallback9235E89CFunc == nil {
		rkllmStreamCallback9235E89CFunc = x
	}
	return (*C.RkllmStreamCallback)(C.RkllmStreamCallback_9235e89c), nil
}

func (x RkllmStreamCallback) PassValue() (ref C.RkllmStreamCallback, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if rkllmStreamCallback9235E89CFunc == nil {
...
func NewRkllmStreamCallbackRef(ref unsafe.Pointer) *RkllmStreamCallback {
	return (*RkllmStreamCallback)(ref)
}

//export rkllmStreamCallback9235E89C
func rkllmStreamCallback9235E89C(ctoken *C.char, cuser_data unsafe.Pointer) {
	if rkllmStreamCallback9235E89CFunc != nil {
		token9235e89c := packPCharString(ctoken)
		user_data9235e89c := (unsafe.Pointer)(unsafe.Pointer(cuser_data))
		rkllmStreamCallback9235E89CFunc(token9235e89c, user_data9235e89c)
		return
	}
	panic("callback func has not been set (race?)")
}

var rkllmStreamCallback9235E89CFunc RkllmStreamCallback
